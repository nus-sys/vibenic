...
**Target board:** Alveo U50 · **Shell:** VibeNIC / QNIC shell v0.3, PR flow ·
**Language:** Bluespec SystemVerilog (BSV) · **Port:** one 100 GbE CMAC

> *A worked example of the three-document pattern. See
