...
The host software this document describes — the kernel module, the DPDK
library, `qnic_pr`/`qnic_reg`/`qnic_info` and `qnic-smi` — is in
[`../../qnic-driver`](../../qnic-driver). This is how to *use* it; that is where
it lives.
